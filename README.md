...
- [PDF 转化Markdow 工具方案调研情况](#pdf-转化markdow-工具方案调研情况)
  ...
  - [Unstructured.io](#unstructuredio)
    ...
    - [支持自定义工作流](#支持自定义工作流)
  - [Markitdown(需要本地部署)](#markitdown需要本地部署)
    - [打包成MCP](#打包成mcp)
...
> 没有表面过期时间，但是从购入的情况来看也是一年到期

### Textin 并发情况

默认 2QPS, 需要商务咨询https://www.textin.com/contact?type=28

 ### PaddleOCR-VL解析价格

以[文档](https://ai.baidu.com/ai-doc/OCR/9k3h7xuv6#%E6%96%87%E6%A1%A3%E8%A7%A3%E6%9E%90%EF%BC%88paddleocr-vl%EF%BC%89)为标准
